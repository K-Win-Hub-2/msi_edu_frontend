...
<template>
  <footer class="">
    <div class="text-sm text-cus-primary">
      <div class="container">
        <div class="grid grid-cols-2 gap-4 px-4 py-8 lg:grid-cols-7">
          ...
          <div
            class="grid grid-cols-1 col-span-3 gap-0 gap-y-5 lg:col-span-5 lg:grid-cols-2"
          >
            <div>
              ...
              <div class="text-sm">
                ...
                <div class="mb-3">
                  ...
                  <div class="leading-relaxed text-cus-primary">
      ...
      <div class="container">
        <div class="px-4 py-3 text-center">
          <span class="text-sm sm:text-center"
            >Copyright © 2023. <a href="#">Myanmar Search International</a>. All
            Rights Reserved.
          </span>
        </div>
      </div>
