...
const previousScholarshipAchiever = () => {
  let currentIndex = currentScholarshipAchieverIndex.value;
  if (currentIndex - 1 < 0) {
    currentScholarshipAchieverIndex.value = scholarshipAchievers.value.length - 1;
  } else {
    currentScholarshipAchieverIndex.value -= 1;
  }
  updateCurrentScholarshipAchiever();
...
<template>
  <div class="overflow-hidden">
    <h1 class="cus-heading text-cus-secondary text-center capitalize mt-12 text-shadow-sm cus-shadow-color">
      Scholarship Achievers
    </h1>
    <div class="flex items-center justify-center gap-3 group mt-11">
      <div
