<template>
  <h1 class="cus-heading text-center mb-[100px]">Our Services</h1>
  ...
  >
    <div class="">
      <swiper
        ...
        :modules="modules"
        class="mySwiper flex justify-center xl:w-[1040px] md:w-[590px]"
      >
        <!-- slider one -->
        <swiper-slide class="flex justify-center py-12 w-full">
          ...
          >
            ...
            <p class="service-desc p-2">
              ...
              Guidance (ECG) mechanism for all students and parents with a view
              to completely understand, appreciate and conceive of Vision,
              Mission and Strategy of MSI and World Education System, being so
              far nourished.
            </p>
          </div>
        </swiper-slide>
        ...
        <swiper-slide class="flex justify-center py-12 w-full">
          ...
          >
            ...
            <p class="service-desc p-2">
              ...
              subject with talent and mindset.
            </p>
          </div>
        </swiper-slide>
        <!-- slider -->
        <swiper-slide class="flex justify-center py-12 w-full">
          ...
          >
            ...
            <p class="service-desc p-2">
              ...
              and module exemption by submitting formally process of application
              to the Academic Institutions concerned.
            </p>
          </div>
        </swiper-slide>
  ...
  <!-- <div class="grid grid-cols-4 gap-x-6 justify-center">
    ...
    >
      ...
      <p class="service-desc p-2">
        ...
        MSI and World Education System, being so far nourished.
      </p>
    </div>
  ...
  <div class="flex justify-center mt-[70px]">
    ...
    >
      <img
        ...
        class="w-[139px] h-[139px] mx-auto border-[10px] border-[#2468A7] service-profile rounded-[50%] -mt-11"
      />
      <h3 class="service-title">Airport Pick-Up and Accommodation</h3>
      <p class="service-desc">
        MSI arranges Airport pick-up and accommodation as well.
      </p>
    </div>

    <div
      class="flex mx-3 flex-col gap-6 text-center mt-[100px] w-[278px] h-[124px] p-2"
    >
      <img src="@/assets/img/MSI Logotext.png" class="mx-auto" />
    </div>
    ...
    >
      <img
        ...
        class="w-[139px] h-[139px] mx-auto border-[10px] border-[#2468A7] service-profile rounded-[50%] -mt-11"
      />
      <h3 class="service-title">Medical Tourism Experiences</h3>
      <p class="service-desc">
        MSI organizes Worldly-worthy Tourism Programs for Medical Check-ups as
        well as touring and shopping with affordable expenditures and time-line
        worthy services.
      </p>
    </div>
  </div>
