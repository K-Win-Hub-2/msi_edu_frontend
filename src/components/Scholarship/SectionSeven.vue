<template>
  <div class="mb-[110px]">
    <div class="">
      <div class="py-[90px]">
        <h1
          class="text-[#FE005F] lg:text-[40px] md:text-[32px] text-[24px] shadow-title leading-[43.5px] text-center font-[700]"
        >
          STUDY GRANT SGD (1,500-1,400)
        </h1>
        <h1
          class="text-[#205887] text-2xl shadow-title lg:text-[32px] md:text-[24px] text-[20px] my-8 leading-[43.5px] text-center font-[700] uppercase"
        >
      ...
      <div class="relative container lg:min-w-[1350px] md:min-w-[600px]">
        ...
        >
          ...
          <swiper-slide class="flex justify-center py-12">
            <div
              class="lg:max-w-[1350px] md:max-w-[600px] lg:min-w-[1350px] h-[346]"
            >
              <div
                class="flex flex-wrap justify-center md:gap-x-[12px] sm:gap-x-6 lg:gap-8 gap-y-[69px]"
              >
                <BusinessCard />
                <BusinessCard />
                <BusinessCard />
          ...
          <swiper-slide class="flex justify-center py-12">
            <div
              class="lg:max-w-[1094px] md:max-w-[600px] lg:min-w-[1094px] h-[346]"
            >
              <div
                class="flex flex-wrap justify-center md:gap-x-[12px] sm:gap-x-6 lg:gap-8 gap-y-[69px]"
              >
