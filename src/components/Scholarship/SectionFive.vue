    ...
    <div class="flex justify-evenly items-center">
      <div class="">
        ...
        <div class="relative container min-w-[1350px]">
          ...
          <div
            class="swiper-business-card-button-prev-25-50-unique absolute left-0 top-1/2 -translate-y-1/2"
          >
            <ChevronLeftIcon
          ...
          <div
            class="swiper-business-card-button-next-25-50-unique absolute right-0 top-1/2 -translate-y-1/2"
          >
            <ChevronRightIcon
