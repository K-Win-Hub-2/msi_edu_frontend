<template>
  <div class="lg:mb-[70px] md:mb-[40px]">
    <div class="">
      <div class="lg:py-[60px] md:py-[10px] md:pb-3">
        <h1
        ...
        >
          Webster University, Thailand Campus (U.S.A)
        </h1>
      </div>
    </div>
...
const fetchData = async () => {
  try {
    const res = await axios.get(
      "https://adminpanel.msieducation.edu.mm/api/scholarship-achievers/scholar-type/8"
    );
    console.log(res);
