  ...
  <div class="mb-[90px]">
    ...
    <div class="flex justify-evenly items-center">
      ...
      <div class="relative container min-w-[1350px]">
        ...
        <div
          class="swiper-business-card-30-50-button-prev-unique absolute left-0 top-1/2 -translate-y-1/2"
        >
          <ChevronLeftIcon
        ...
        <div
          class="swiper-business-card-30-50-button-next-unique absolute right-0 top-1/2 -translate-y-1/2"
        >
          <ChevronRightIcon
