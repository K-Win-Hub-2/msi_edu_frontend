<template>
  ...
  <section class="container py-24">
    <div class="text-center space-y-6">
      <p>
        A study abroad experience in UK will make you stand out from the crowd.
  ...
  <section class="bg-white">
    <div class="container px-6 pt-6 pb-24">
      ...
      <Universities country="uk"></Universities>
    </div>
  </section>
  <section class="bg-white">
    <div class="container px-6 pt-6 pb-24">
...
<script setup>
import bannerImage from "../../assets/img/countries/banner/uk.jpg";
