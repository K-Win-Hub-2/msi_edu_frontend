<template>
  ...
  <section class="container py-24">
    <div class="text-center space-y-6">
      <p>
        A study abroad experience in Switzerland will make you stand out from
        the crowd. Once you’ve arrived in Southeast Asia, you’ll realize you
        have much in common with others who journey to this exotic destination:
        a sense of adventure and open-minded nature, a healthy dose of
  ...
  <section class="bg-white">
    <div class="container px-6 pt-6 pb-24">
      ...
      <Universities country="switzerland"></Universities>
    </div>
  </section>
  <section class="bg-white">
    <div class="container px-6 pt-6 pb-24">
      ...
      <TestSection country="switzerland" />
    </div>
  </section>
  <section>
    <div class="container px-6 pt-6 pb-24">
...
<script setup>
import bannerImage from "../../assets/img/countries/banner/switzerland.jpg";
