<template>
  ...
  <section class="container py-24">
    <div class="text-center space-y-6">
      <p>
        A study abroad experience in Malaysia will make you stand out from the
  ...
  <section class="bg-white">
    <div class="container px-6 pt-6 pb-24">
      ...
      <Universities country="malaysia"></Universities>
    </div>
  </section>
  <section class="bg-white">
    <div class="container px-6 pt-6 pb-24">
...
<script setup>
import bannerImage from "../../assets/img/countries/banner/malaysia.jpg";
