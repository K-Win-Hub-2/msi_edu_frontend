<template>
  ...
  <section class="container py-24">
    <div class="text-center space-y-6">
      <p>
        A study abroad experience in Canada will make you stand out from the
  ...
  <section class="bg-white">
    <div class="container px-6 pt-6 pb-24">
      ...
      <Universities country="canada"></Universities>
    </div>
  </section>
  <section class="bg-white">
    <div class="container px-6 pt-6 pb-24">
